package test.sample.cassandraInteraction.examples;

import java.io.IOException;

import test.sample.cassandraInteraction.repository.UserRepository;
import test.sample.cassandraInteraction.util.*;
