package test.sample.DroolsPOC.controllers;
...
import test.sample.DroolsPOC.service.JewelleryShopService;
...
public class JewelleryShopController {
    ...
    public Product getQuestions(@RequestParam(required = true) String type, @RequestParam(required = true) String location) {
